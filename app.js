...
app.get('/api/room-status-from-student', (req, res) => {
  // Assuming you have a function to retrieve room status from student_status.html
  const roomStatusData = getRoomStatusFromStudent(); // Replace this with actual function

  // Assuming roomStatusData is an array of room status objects
  res.status(200).json(roomStatusData);
});

// API endpoint for updating room
app.get('/edit-room.html', (req, res) => {
  // Assuming you have an HTML file for editing room details named edit-room.html
